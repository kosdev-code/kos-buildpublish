...
Each key is described below:
    ...
    artifacts.server: [OPTIONAL]- specifies the server to publish against used to point to studio2 server @ studiotwo.kosdev.com
...
6. Upload your encrypted 7z file to a location that is accessible by the Github Runners. It should have a URL where it can be accessed.

7. In your Github repository, go to Settings and create 2 secrets:
...
8. In your Github repository, create a kosbuild.json file which drives the build process. Place it in the .github folder. Example:
